...
class Plan(
    ...
    _inherited_context: Optional[FmfContext] = field(default=None, internal=True)
    _inherited_environment: Optional[Environment] = field(default=None, internal=True)
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._derived_plans = []
        self._inherited_context = fmf_context
        self._inherited_environment = environment
    ...
    def environment(self) -> Environment:
        ...
        # If the plan inherits context, add it to the environment
        if self._inherited_environment:
            environment_from_spec.update(self._inherited_environment)
